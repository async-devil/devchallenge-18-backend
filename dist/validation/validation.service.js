...
let ValidationService = class ValidationService {
    constructor(errorsServise) {
        this.errorsServise = errorsServise;
    }
    checkIfObject(...args) {
        args.forEach((value) => {
    ...
    checkIfCutBoxDtoValid(checkSubject) {
    ...
    checkIfBoxFits(data) {
        const box = new Box_1.Box(data);
        if (!box.checkIfBoxFits())
            this.errorsServise.throwInvalidSizeError();
        return true;
    }
};
